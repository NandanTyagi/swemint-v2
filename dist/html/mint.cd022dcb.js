...
})({"1NI3B":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "4a9fc060cd022dcb";
...
},{}],"loT0s":[function(require,module,exports) {
...
const init = async ()=>{
    ...
    /********************** MINT ****************************/ function toggleMintBtn(address) {
        console.log("in mint Toogle", address);
        if (user1) removeConnectBtn(address);
        else removeMintBtn(address);
    }
    ...
    async function mint(address) {
        ...
        if (isWhitelisted) console.log("Welcome you are whitelisted");
        else console.log("Sorry you are not elegible for the mint");
    }
    connectionCheck();
    mintBtn.addEventListener("pointerup", ()=>mint(window.ethereum.selectedAddress));
/********************** MINT ****************************/ };
document.addEventListener("DOMContentLoaded", ()=>init());

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../utility/shortenAddress":"1QPnu"}],"gkKU3":[function(require,module,exports) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["1NI3B","loT0s"], "loT0s", "parcelRequireee82")

//# sourceMappingURL=mint.cd022dcb.js.map
